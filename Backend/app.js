...
app.post('/service',(req,res)=>{
    ...
    newParam.save().then(()=>{
       ...
       if( Fever==="Yes" && Diarrheoa==="Yes" && Rose_spots==="Yes"){
        console.log("You have possibilty of 65% of suffering from Typhoid fever according to our Rough Set Theory Algorith");
       }
       else{
        console.log("You don't have possibilty of suffering from Typhoid fever according to our Rough Set Theory Algorith");
       }
